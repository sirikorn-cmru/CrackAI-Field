...
7. **การกำหนดขอบเขต "ทีม/อาคารที่หัวหน้าผู้สำรวจรับผิดชอบ" สำหรับ FR-32 อาศัยข้อมูลการมอบหมายงาน (spec, FR-32 อ้างอิง FR-20) — เพิ่มเข้ามา 2026-09-02** — สถาปัตยกรรมนี้สมมติว่า Primary Data Store มีความสัมพันธ์ระหว่างอาคาร ↔ ทีมสำรวจ ↔ หัวหน้าผู้สำรวจที่เพียงพอสำหรับให้ Backend Service ใช้ตรวจสอบขอบเขตสิทธิ์ก่อนตอบผลการค้นหา audit trail ได้ทุกครั้ง (ต่อยอดจากข้อมูลการมอบหมายงานของฟีเจอร์ 8/FR-20 ที่มีอยู่แล้ว) ถ้าสมมติผิด (เช่น หัวหน้าผู้สำรวจคนหนึ่งดูแลได้มากกว่า 1 ทีม หรือทีมเปลี่ยนหัวหน้าระหว่างทาง ทำให้ความสัมพันธ์ซับซ้อนกว่าที่คาดไว้) จะกระทบทั้งโมเดลข้อมูลใน Primary Data Store และ logic การตรวจสอบขอบเขตสิทธิ์ใน Backend Service ที่ระบุไว้ใน §5.5
...
- รูปแบบการจัดทำดัชนี/กลยุทธ์การค้นหาที่มีประสิทธิภาพสำหรับการค้นหา/กรองประวัติทั่วทั้งระบบ (FR-33) เมื่อปริมาณ audit log สะสมมากขึ้นเรื่อยๆ โดยไม่มีการลบอัตโนมัติ (ดูข้อสมมติที่ 6 ใน §7) — เพิ่มเข้ามา 2026-09-02
