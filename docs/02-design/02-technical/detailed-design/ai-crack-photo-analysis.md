...
## 6. ประเด็นรอตัดสินใจส่งต่อจาก architecture/technology-stack

Runtime ของโมเดล AI วิเคราะห์รอยร้าวบนอุปกรณ์ (7.2) และขนาด/ความละเอียดของภาพที่ AI ใช้วิเคราะห์จริง — **เลื่อนโดยตั้งใจ (deferred by decision, 2026-09-04)** ไม่ใช่ประเด็นค้างคาเพราะขาดข้อมูล บล็อกเฉพาะ Phase 3 (ยังไม่มีโมเดล/ชุดข้อมูลจริง) ไม่บล็อกฟีเจอร์นี้ใน Phase 1-2 — **แนวทางชั่วคราวของ Phase 2**: เก็บไฟล์ภาพต้นฉบับ (`DamagePhoto.photo_file` ที่บันทึกจาก [[#2. Operation ↔ Entity ที่กระทบ|7.1]]) ไว้ที่ความละเอียดเต็มเสมอ ไม่ลดขนาด/บีบอัดที่กระทบความละเอียดตอนบันทึก เพราะการลดความละเอียดภายหลัง (downscale) ทำได้เสมอเมื่อ Runtime ของ AI ถูกเลือกแล้วและรู้เกณฑ์ที่ต้องการจริง แต่การเพิ่มความละเอียดย้อนหลัง (upscale) ทำไม่ได้ — **ห้ามระบุตัวเลขความละเอียดหรือชื่อ AI runtime ในเอกสารนี้จนกว่า [[technology-stack]] จะปิดประเด็นนี้** (ดู [[technology-stack#4.1 Runtime ของโมเดล AI วิเคราะห์รอยร้าว + ขนาด/ความละเอียดภาพ (เลื่อนโดยตั้งใจ — deferred by decision, 2026-09-04)|technology-stack §4.1]], [[architecture#8. ประเด็นรอตัดสินใจ|architecture §8]])
