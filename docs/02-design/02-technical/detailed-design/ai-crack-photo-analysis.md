...
ทุกครั้งที่วิเคราะห์ใหม่ (เช่น ถ่ายภาพใหม่แล้ววิเคราะห์ซ้ำ) ระบบสร้าง `AIAnalysisResult` ระเบียนใหม่เสมอ ไม่แก้ไขระเบียนเดิม — สอดคล้องกับกฎ 1 ใน [[db-spec#9. กฎทางธุรกิจที่กระทบโครงสร้างข้อมูล|db-spec หัวข้อ 9]]
...
| `linked_area_id` ไม่ตรงประเภทกับ `linked_area_type` | ปฏิเสธการบันทึกภาพ | [[api-spec#7. ถ่ายภาพและประเมินรอยร้าวด้วย AI พร้อมทางเลือกกรอกเอง (Human-in-the-loop)\|api-spec 7.1]], [[db-spec#9. กฎทางธุรกิจที่กระทบโครงสร้างข้อมูล\|db-spec กฎ 6]] |
